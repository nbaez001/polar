...
/**
 * Detallesaldobobeda generated by hbm2java
 */
public class Detallesaldobobeda  implements java.io.Serializable {
    ...
    public Detallesaldobobeda() {
    }

    public Detallesaldobobeda(Bobeda bobeda, String denominacion, double valor, int cantidad, double monto, boolean apertura) {
       this.bobeda = bobeda;
