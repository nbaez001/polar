    ...
    <body class="nav-md" style="font-family: Cambria">
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Crear nueva persona <i class="fa fa-book"></i></h2>
                    ...
                    <form id="formulario3">
                        ...
                        <div id="bodyModal" class="modal-body">
                            <fieldset style="margin-top: 0px">
                                <legend style="font-family: Cambria;font-size: 10px">DATOS PERSONALES</legend>
        ...
        <script type="text/javascript">
            ...
            $.limpiarControles2 = function () {
                ...
                $("#formulario3 input[name=profesion]").val("");
            };

            $.quitarClientenatural = function (id) {
                $.ajax({
                    type: 'POST',
                    url: '${pageContext.request.contextPath}/admision/quitarpersona',
                    data: {id: id},
                    dataType: "json",
                    success: function (data) {
                        if (data === 0) {
                            $.notificar("Notificacion", "error", "Error al eliminar personal");
                        }
                        else {
                            $.notificar("Notificacion", "success", "La persona se elimino correctamente");
                            $("#" + id).hide();
                        }
                    },
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#formulario").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "${pageContext.request.contextPath}/admision/persona",
                ...
                $("#formulario3").validate({
                    ...
                    submitHandler: function () {
                        ...
                        var persona = {
                            ...
                            celular: $("#formulario3 input[name=celular]").val(),
                            email: $("#formulario3 input[name=email]").val(),
                            ruc: $("#formulario3 input[name=ruc]").val(),
                            estadocivil: estadocivil,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "${pageContext.request.contextPath}/admision/modificarpersona",
                            contentType: "application/json",
            ...
            $.validarPersona = function (dni) {
                if (dni <= 99999999 && dni > 9999999) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '${pageContext.request.contextPath}/admision/validarpersona',
                        data: {dni: dni},
                        dataType: "json",
                        success: function (data) {
                            if (data === 0) {
                                $("#labelDni").html('Dni (*) <span class="label label-success">Persona nueva</span>');
                            }
                            else {
                                $("#labelDni").html('Dni (*) <span class="label label-danger">Persona existe</span>');
                                ...
                                $("#formulario input[name=profesion]").val(data.profesion);
                            }
                        },
                        error: function (xhr, status, error) {
                            $.notificar("Notificacion", "error", "Error: " + error);
            ...
            $.modificarClientenatural = function (id) {
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath}/admision/cargarpersona",
                    data: {id: id},
                    dataType: "json",
                    success: function (data) {
                        if (data !== 0) {
